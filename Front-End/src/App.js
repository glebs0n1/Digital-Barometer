  ...
  return (
    <div>
      <header className="App-header">
        ...
        <div className="HeaderInfo">
          <div className="HeaderText">
            ...
            <p>Temperature: {weatherData.current ? weatherData.current.temp_c : 'N/A'}°C</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="WeatherInfo">
            <div className="WeatherIcon">
              <img
                src={weatherData.current ? weatherData.current.condition.icon : '/images/unknown.png'}
                alt="Weather Icon"
              />
            </div>
            <div className="WeatherDetails">
              <p>Temperature: {weatherData.current ? weatherData.current.temp_c : 'N/A'}°C</p>
              <p>Pressure: {weatherData.current ? weatherData.current.pressure_mb : 'N/A'} hPa</p>
              <p>Humidity: {weatherData.current ? weatherData.current.humidity : 'N/A'}%</p>
              <p>Wind Speed: {weatherData.current ? weatherData.current.wind_kph : 'N/A'} km/h</p>
      ...
      <footer>
        ...
        <a href="https://github.com/glebs0n1" style={{ color: 'white' }}>GitHub</a>
      </footer>
    </div>
  );
}
